...
class MyApp extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
   return MaterialApp(
     title: 'Flutter Demo',
     theme: ThemeData(
       primarySwatch: Colors.blue, // Основна тема додатку
     ),
     home: const LoginPage(), // Сторінка входу за замовчуванням
   );
 }
}


// Компонент для кнопки, щоб уникати дублювання
class CustomButton extends StatelessWidget {
 final String text; // Текст на кнопці
 final VoidCallback onPressed; // Функція для дії при натисканні
...
class LoginPage extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
   return Scaffold(
     appBar: AppBar(title: const Text('Логін')), // Заголовок
     body: Center(
       child: Column(
         ...
         children: <Widget>[
           ...
           child: TextField(
             ...
             obscureText: true, // Захист введення пароля
           ),
           ),
           ...
           CustomButton(
             ...
             onPressed: () {
               ...
               ); // Перехід на головну сторінку після входу
             },
           ),
